...
INSERT INTO tb_fornecedor_hospedagem VALUES (tp_fornecedor_hospedagem('77777777000133', 'Mandarin Oriental Milan', tp_lista_contatos(tp_contato(tp_telefone('390287323000'), tp_email('momln-reservations@mohg.com')), tp_contato(tp_telefone('390287323001'), tp_email('momln-events@mohg.com'))), 'Hotel', 3.97, 190));
